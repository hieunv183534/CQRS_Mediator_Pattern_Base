...
@Component({
  selector: 'app-dash-board-column',
  templateUrl: './dash-board-column.component.html',
  styleUrls: ['./dash-board-column.component.scss']
})
export class DashBoardColumnComponent implements OnInit, OnChanges {
