...
@Component({
  selector: 'app-dbs-tile-toantrinh-lientinh',
  templateUrl: './dbs-tile-toantrinh-lientinh.component.html',
  styleUrls: ['./dbs-tile-toantrinh-lientinh.component.scss']
})
export class DbsTileToantrinhLientinhComponent implements OnInit {
