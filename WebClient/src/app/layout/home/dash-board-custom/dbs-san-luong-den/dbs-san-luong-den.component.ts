...
@Component({
  selector: 'app-dbs-san-luong-den',
  templateUrl: './dbs-san-luong-den.component.html',
  styleUrls: ['./dbs-san-luong-den.component.scss']
})
export class DbsSanLuongDenComponent implements OnInit {
