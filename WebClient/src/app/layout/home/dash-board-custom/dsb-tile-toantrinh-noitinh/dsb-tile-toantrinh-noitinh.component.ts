...
@Component({
  selector: 'app-dsb-tile-toantrinh-noitinh',
  templateUrl: './dsb-tile-toantrinh-noitinh.component.html',
  styleUrls: ['./dsb-tile-toantrinh-noitinh.component.scss']
})
export class DsbTileToantrinhNoitinhComponent implements OnInit {
