...
@Component({
  selector: 'app-dbs-tile-toantrinh-noitinh2',
  templateUrl: './dbs-tile-toantrinh-noitinh2.component.html',
  styleUrls: ['./dbs-tile-toantrinh-noitinh2.component.scss']
})
export class DbsTileToantrinhNoitinh2Component implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    let colors = ['#009688','#ff8a65','#f9f21e','#f44336'];
    this.loading = true;
    this.data = [];
