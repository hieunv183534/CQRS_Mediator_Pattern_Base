...
@Component({
  selector: 'app-dbs-tile-toantrinh-lientinh3',
  templateUrl: './dbs-tile-toantrinh-lientinh3.component.html',
  styleUrls: ['./dbs-tile-toantrinh-lientinh3.component.scss']
})
export class DbsTileToantrinhLientinh3Component implements OnInit {
  @Input() options: any;
