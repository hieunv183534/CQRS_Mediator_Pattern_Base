...
import { DimDashboardApi, DanhMucDashboardSettingGetDataQuery } from 'src/app/_shared/bccp-api.services';
import { Component, Input, OnInit } from '@angular/core';
import * as Highcharts from 'highcharts';

@Component({
  selector: 'app-dbs-tile-toantrinh-noithanh2',
  templateUrl: './dbs-tile-toantrinh-noithanh2.component.html',
  styleUrls: ['./dbs-tile-toantrinh-noithanh2.component.scss']
})
export class DbsTileToantrinhNoithanh2Component implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    let colors = ['#4CAF50','#ff8a65','#f9f21e','#f44336'];
    this.loading = true;
    this.data = [];
