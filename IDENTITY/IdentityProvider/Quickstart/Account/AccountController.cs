...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<object> CreateAccount([FromBody] IdentityProvider.Quickstart.Account.AccountModel model)
        {
            ...
            return await _userManager.CreateAsync(userData, model.Password);
        }

        [HttpPost]
        [Route("api/[controller]/[action]")]
        public async Task<object> UpdateAccount([FromBody] IdentityProvider.Quickstart.Account.AccountModel model)
        {
            if (string.IsNullOrEmpty(model.ClientSecrets))
            {
                throw new Exception("ClientSecrets not Empty");
        ...
        [HttpPost]
        [Route("api/[controller]/[action]")]
        public async Task<object> LockAccount([FromBody] IdentityProvider.Quickstart.Account.LockAccountModel model)
        {
            if (string.IsNullOrEmpty(model.ClientSecrets))
            {
                throw new Exception("ClientSecrets not Empty");
            ...
            var userOld = await _userManager.FindByNameAsync(model.Username);
            userOld.LockoutEnd = model.LockoutEnd;
            userOld.AccessFailedCount = model.AccessFailedCount;
            userOld.LockoutEnabled = true;
