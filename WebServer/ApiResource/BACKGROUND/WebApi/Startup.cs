...
using System;
using NOM.BACKGROUND.Domain;
using NOM.DomainGlobal;
using NOM.BACKGROUND.WebApi.Filters;
using Hangfire;
using Microsoft.AspNetCore.DataProtection;
using Microsoft.EntityFrameworkCore;
using System.IO;

namespace NOM.BACKGROUND.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configure.Title = "BACKGROUND API";
            ...
            {
                opt.Queues = new string[2] { "default", "test" };
            });
